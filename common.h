...
struct Constr {
    int op_0;        // index of op_o
    int op_1;        // index of op_1
    int difference;  // latency of the difference
};
...
struct Stmt {
    ...
    virtual bool is_mem_stmt() {
        return false;
    }
    virtual int get_arr_idx() {
        return -1;
    }
};
...
struct MemStmt : Stmt {
    ...
    virtual bool is_mem_stmt() override {
        return true;
    }
    virtual int get_arr_idx() override {
        return arr_idx;
    }
};
